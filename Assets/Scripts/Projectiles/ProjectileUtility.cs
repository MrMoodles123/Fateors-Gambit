...
namespace Projectiles
{
	...
	{
		// Performs a lag-compensated raycast for projectiles
		...
		// Performs a lag-compensated raycast that detects multiple hits
		...
		// Processes multiple raycast hits while filtering out unnecessary ones
