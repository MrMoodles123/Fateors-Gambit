...
namespace Projectiles
{
	...
	public class AdvancedKinematicProjectile : KinematicProjectile
	{
        ...
        // handles fixed updates for projectile movement and interactions
        ...
        // returns render position for projectile
		...
		// initialise projectile settings
		...
		// calculate projectile movement position based on current tick and deltaTime
        ...
        // processes the bounce, adjusting position, velocity, and bouncing count
		...
		// plays bounce sound when bounce occurs
