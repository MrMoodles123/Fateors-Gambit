...
namespace Projectiles
{
	...
	public class SprayProjectile : KinematicProjectile
	{
        ...
        /// fixed update method for the spray projectile. Handles movement, collision detection, and impact processing
        ...
        // returns the position to render the projectile at based on the interpolation of current and previous data
        ...
        // renders the projectile's visuals. The projectile rotates to face the direction of its velocity
        ...
        // calculates the projectile's position at a given tick based on its velocity, gravity, and drag forces
