...
namespace Projectiles
{
	...
	public abstract class KinematicProjectile : ProjectileBase, IBufferView<KinematicData>
	{
        ...
        // returns data required to initialize projectile movement
		...
		// hanlde projectile logic on every fixed update
		...
		// initialise projectile position and visual state when initially activated
        ...
        // reder projectile movement based on previous and current position
