...
namespace Projectiles
{
	...
	public class SimpleKinematicProjectile : KinematicProjectile
	{
        ...
        // fixed update method for the projectile. Handles projectile movement and collision detection
        ...
        // calculates the projectile's position at a given tick based on its velocity and the time elapsed
