...
namespace Projectiles
{
	...
	public class HomingProjectile : KinematicProjectile
	{
        ...
        // gets fire data for homing projectile
        ...
        // updates projectile position and checks for collisions each frame
        ...
        // calculates render position between current and previous positions of projectile
        ...
        // finds the best target to home in on based on various conditions like distance, angle, and visibility
        ...
        // recalculates target to home in on after a certain amount of time
        ...
        // updates projectile direction based on target position
        ...
        // return position of target based on selected homing position (Body, Head, Ground).
