...
namespace Projectiles
{
	...
	public class FlyingHitscanProjectile : HitscanProjectile
	{
		...
		// set start and target positions, roatation, and calcualte travel duration
		...
		// update porjectile movement over time and check if projectile has reached its destination
