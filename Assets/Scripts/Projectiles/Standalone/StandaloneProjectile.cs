...
namespace Projectiles
{
	...
	public sealed class StandaloneProjectile : ContextBehaviour
	{
		...
		// Fire projectile from specified position and direction
		...
		// called when the object is spawned in the networked world
		...
		// called on every network fixed update
		...
		// render method for the projectile's visual
		...
		// prepare context for projectile
