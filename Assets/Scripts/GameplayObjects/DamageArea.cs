...
namespace Projectiles
{
	...
	public class DamageArea : NetworkBehaviour
	{
		...
		//remove inactive targets an dapply damange if cooldown finished
		...
		// MONOBEHAVIOUR
		// called when a target enters damage area
		...
		// called when a target exits damage area
		...
		// PRIVATE METHODS
		// apply damage to all targets within area
		private void Fire()
		{
