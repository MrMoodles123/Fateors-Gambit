...
namespace Projectiles.UI
{
	...
	public class SimpleMove : NetworkBehaviour
	{
		...
		// movement offset, speed, and smoothsness variables
		[SerializeField]
		...
		// called every fixed update on network to ofix varibles based on current tick
		...
		// called every render frame to update object position
		...
		// PRIVATE METHODS
		// updates objects position based on elapsed time and movement settings
