...
namespace Projectiles
{
	...
	public sealed class GameManager : SimulationBehaviour, INetworkRunnerCallbacks
	{
		...
		// varibales to store gameplay  information and player preferences
		[SerializeField]
		...
		// handles players disconnecting by despawning their object
		...
		// empty callbacks for unused network events
